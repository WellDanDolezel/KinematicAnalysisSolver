function sys = add_joint_simple_driving(sys, body_name, coord_name, coord_fun, coord_fun_dt, coord_fun_dtt)
    arguments
        sys (1,1) struct
        ...
        coord_fun_dtt (1,1) function_handle
    end
